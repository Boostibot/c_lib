...
typedef void* (*Failing_Allocator_Panic)(Allocator* allocator, isize new_size, void* old_ptr, isize old_size, isize align, void* context);
...
EXPORT void* failling_allocator_allocate(Allocator* self, isize new_size, void* old_ptr, isize old_size, isize align);
...
EXPORT void* failling_allocator_allocate(Allocator* self_, isize new_size, void* old_ptr, isize old_size, isize align)
{
    Failing_Allocator* self = (Failing_Allocator*) (void*) self_; 
    if(self->panic_func)
        return self->panic_func(self_, new_size, old_ptr, old_size, align, self->panic_context);
